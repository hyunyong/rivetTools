...
process.RAWSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('QCD_Pt_%dto%d_TuneCUETP8M1_13TeV_pythia8_GEN_%03d.root'%(min_pt, max_pt, f_num)),
...
process.rivetAnalyzer.OutputFile = cms.string('QCD_Pt_%dto%d_TuneCUETP8M1_13TeV_pythia8_rivet_%03d.yoda'%(min_pt, max_pt, f_num))
